...
import {CHANGE_MODES} from "../../../module/common/constants.mjs";

const ADD = CHANGE_MODES.ADD
const MULTIPLY = CHANGE_MODES.MULTIPLY
const UPGRADE = CHANGE_MODES.UPGRADE
const DOWNGRADE = CHANGE_MODES.DOWNGRADE
const OVERRIDE = CHANGE_MODES.OVERRIDE
const CUSTOM = CHANGE_MODES.CUSTOM
const POST_ROLL_MULTIPLY = CHANGE_MODES.POST_ROLL_MULTIPLY;
